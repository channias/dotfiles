...
plugins=(colored-man colorize common-aliases git git-extras github gitignore history jsontools node npm nvm postgres vagrant vim-interaction ssh-agent tmux python docker-compose docker-machine docker kitchen kubectl minikube helm sudo terraform)
